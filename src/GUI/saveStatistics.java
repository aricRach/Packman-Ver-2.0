...
public class saveStatistics {
	...
	public static String exploitData() {
		...
		try {
			...
			//String allCustomersQuery = "SELECT Point,FirstID FROM logs WHERE SomeDouble="+2128259830+" AND FirstID="+205357619 ;
			...
			while(resultSet.next())
			{
				...
				//System.out.println(resultSet.getDouble("SomeDouble"));
